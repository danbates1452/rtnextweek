...
class rtw_image {
    public:
        ...
        rtw_image(const char* image_filename) {
            ...
            // If the image was not found, searches for the specified image file first from the current
            // directory, then in the images/ subdirectory, and the _that_ parent, and so on, for six
            // levels up.
        ...
        bool load(const std::string& filename) {
            ...
            // The resulting data buffer contains the three [0.0, 1.0] floating-point
            // values for the first pixel (red, green, blue).
            // Pixels are contiguous, going left to to right for the width of the image,
    ...
    private:
        ...
        void convert_to_bytes() {
            ...
            // converting from [0.0, 1.0] float values
